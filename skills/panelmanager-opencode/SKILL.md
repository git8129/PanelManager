...
- 源码包解压后应直接成为完整工作区，包含 `PanelManager/`、`FloatingWindow/`、`Installer/`、`scripts/`、`skills/`、`AGENTS.md`、`PanelManager.sln`。
- `PanelManager/Tools/**` 不进入源码包；安装版运行时由 exe 同级 `Tools/` 补复制到工作区 `PanelManager/Tools/`。
...
- payload：`.sandbox/artifacts/installer/payload.zip`
...
- `scripts/**`
- `Installer/**`
- `PanelManager/**`，但不含 `PanelManager/Tools/**`
- `FloatingWindow/**`
- `PanelManager.sln`
- `README.md`
...
- UI 改版、视觉优化、布局调整、交互打磨：`https://github.com/nextlevelbuilder/ui-ux-pro-max-skill`
